						...
						@foreach($tipos_de_ambiente as $tip)
							<tr>
								...
								<td>
            						...
            						data-mynombre="hola" data-mycapacidad="{{$tip->capacidad}}" 
            						data-mycosto="{{$tip->costo}}" data-mydisponible="{{$tip->disponible}}" data-catid="{{$tip->id}}" data-toggle="modal" data-target="#edit"
            						>Editar
									</button>                
    ...
    <div class="modal-content">
      <div class="modal-header "  >
        ...
        <h4 class="modal-title" id="myModalLabel">Nuevo tipo de evento</h4>
	         ...
	         <form action="{{route('TiposDeAmbiente.store')}}" method="post">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Editar tipos de ambientes</h4>
      	...
      	<form action="{{route('TiposDeAmbiente.update','test')}}" method="post">
      		...
      		{{csrf_field()}}
	      <div class="modal-body">
	      	<input type="hidden" name="tipos_de_ambiente_id" id="tip_id">
	      	@include('Reservas.FormTipoDeReserva')
	      </div>
	      <div class="modal-footer">
